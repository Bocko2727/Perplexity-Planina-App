...
import {
  ...
  CircleCheckBig, Circle, Car, Bus, TrainFront, Heart, HeartOff, Copy,
  Check, Trash2, Calendar, Clock, TrendingUp, TrendingDown, Ruler, Gauge,
  Cloud, Shield, Backpack, StickyNote, Menu, Filter, ArrowUpDown,
...
import {
  DIFFICULTY_STYLES, GEAR_LISTS, gearListFor,
